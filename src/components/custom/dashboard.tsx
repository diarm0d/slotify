...
const bookedEvents = [
  ...
  { id: 2, title: "Client Presentation", date: "2023-06-16", time: "2:00 PM", attendees: 3 },
  { id: 3, title: "Project Kickoff", date: "2023-06-17", time: "9:00 AM", attendees: 8 },
]
            ...
            <CardContent>
              <ul className="space-y-4">
                {bookedEvents.map((event) => (
                  <li key={event.id} className="flex items-center justify-between p-4 bg-muted rounded-lg">
                    <div>
        ...
        <TabsContent value="types">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage your available event types</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-4">
                {eventTypes.map((type) => (
                  <li key={type.id} className="flex items-center justify-between p-4 bg-muted rounded-lg">
                    <div>
